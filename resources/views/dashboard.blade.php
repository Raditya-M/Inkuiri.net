    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      <div class="hidden sm:mb-8 sm:flex sm:justify-center">
        <div class="relative rounded-full px-3 py-1 text-sm/6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
          Menuju ke <a href="event" class="font-semibold text-indigo-400"><span aria-hidden="true" class="absolute inset-0"></span>Event <span aria-hidden="true">&rarr;</span></a>
        </div>
      </div>
      <div class="text-center">
        <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">The more that you read, the more things you will know.</h1>
        <p class="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">"Success is walking from failure to failure with no loss of enthusiasm.".</p>
      </div>
    </div>
